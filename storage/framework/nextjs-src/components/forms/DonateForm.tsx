  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label={t("amount")} name="amount" type="number" required />
      </div>
      <div>
        <label className="mb-1.5 block text-sm font-medium text-ink/80">{t("method")}</label>
        <select
          name="method"
          required
        ...
        >
          ...
          <option value="card">Card (Chapa)</option>
        </select>
      </div>
      <button
        type="submit"
